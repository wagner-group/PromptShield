    ...
    for index, data in enumerate(dataset):
        ...
        if(alternative_tokens == None):
            ...
            if first_token.text == "1":
                ...
                score = (1 - zero_score) if zero_score > 0.5 else 0  #If first token is 0 and has score less than 0.5, assume score of "1" is 0             
            else:
                score = 0  
        else:
...
if args.model_name == "prompt-injection-detection":
    if version_num == 32 or version_num == 30 or version_num == 37 or version_num == 56 or version_num == 84:
