...
for i, data_point in enumerate(train_datasetJSON):
    if data_point["type"] == "Benign - chat_data" or data_point["type"] == "Benign - open_domain":
        continue
    #create train/evaluation splits for predibase
    split = "train"
    #create jsonline
    prompt =   concatenate_with_random_newlines(data_point["instruction"],  data_point["input"]) 
...
with open(f"_2024-12-07_20k_random_nl_final_no_conversational.jsonl", 'w') as outfile:
